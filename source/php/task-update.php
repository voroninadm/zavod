...
$conn = new mysqli($servername, $username, $password, $db_machine);
...
if (isset($machineType)) {
  if ($machineType == "print") {
    ...
    $sql = "UPDATE `primbase` SET
                      ...
                      `waste_raw`='{$waste_raw}',
                      `waste_sum`='{$waste_sum}',
                      `prepare_mass`='{$prepare_mass}',
                      `prepare_hours`='{$prepare_hours}',
                      `correction_PN`='{$correction_PN}',
                      `correction_CMYK`='{$correction_CMYK}',
                      `electro`='{$electro}',
